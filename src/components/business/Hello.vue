 ...
 * @LastEditTime: 2023-08-28 14:26:54
 * @site: book.palxp.com
-->
<template>
  <div class="wrap">
    <div ref="letterEl" class="my_letter">
      ...
      <div ref="paperEl" class="paper">
        <span class="ZK">2022 年度报告</span><span class="ZK">广告位招租~</span><span>( ͡°ᴥ ͡° ʋ)</span>
      </div>
    </div>
  </div>
</template>
...
.envelope {
  ...
  height: 100%;
  z-index: 2;
  background: url("https://pic.imgdb.cn/item/64ec0ffc661c6c8e54ba07c7.png")
...
.paper {
  ...
  left: 0;
  display: inline-block;
  background: url("https://pic.imgdb.cn/item/64ec11f1661c6c8e54babe18.png")
    no-repeat center center;
  background-size: contain;
  opacity: 0;
  width: 100%;
